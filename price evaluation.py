...
lable_one =  Label(window, text="Enter Product Name :", font=("Comic Sans MS", 30))
lable_one.configure(bg = "blue")
lable_one.place(relx=0.2, rely=0.1, anchor="center")

product_name =  StringVar()
product_name_entry =  Entry(window, textvariable=product_name, width=40)
product_name_entry.place(relx=0.5, rely=0.1, anchor="center")

search_button =  Button(window, text="Search", width=40, command= search)
search_button.place(relx=0.5, rely=0.2, anchor="center")

l1 =  Label(window, text="Flipkart", font=("Arial", 20))
l1.configure(bg = "yellow")
l2 =  Label(window, text="Ebay", font=("Arial", 20))
l2.configure(bg = "yellow")
l3 =  Label(window, text="Croma", font=("Arial", 20))
l3.configure(bg = "yellow")
l4 =  Label(window, text="Amazon", font=("Arial", 20))
l4.configure(bg = "yellow")
l6 =  Label(window, text="All urls", font=("Arial", 20))
l6.configure(bg = "yellow")
l8 =  Label(window, text="Loading.....", font=("Arial", 30))
...
box5 =  Text(window, height=15, width=50, yscrollcommand=scrollbar.set, fg="yellow", cursor="hand2")
box5.configure(bg = "red")
